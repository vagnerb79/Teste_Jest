...
test('A diferenca de 10 e 2 não deve ser igual a 5', () => {
...
test('A multiplicacao de 3 e 2 não deve ser igual a 5', () => {

    expect(product(3, 2)).not.toBe(5);
...
test('A divisao de 10 e 2 não deve ser igual a 8', () => {

    expect(divi(10, 2)).not.toBe(8);
